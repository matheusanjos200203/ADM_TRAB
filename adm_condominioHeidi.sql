/*
	Ana Carolina Carvalho Cassiano
	José Wigner Quintino Bindaco
	Mateus Sobrinho Menines
	Matheus Batista dos Anjos
	Tarsis Barcaro Nogueiro
*/
...
CREATE TABLE SINDICO (
    PRIMARY KEY (ID_CONDOMINIO, ID_PROPRIETARIO, VIGENCIA_INICIO DATE, VIGENCIA_TERMINO DATE),
